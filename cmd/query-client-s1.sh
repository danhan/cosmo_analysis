...
USAGE="USAGE: <isCoprocessor(1,0)> <query(1,2)> <input-argument-configured>"
...
${JAVA_HOME}/bin/java -Xmx1500m -classpath ${COMMONLIB}:${HBASELIB}:${HBASECONF}:${HADOOPLIB}:${HADOOPCONF}:${MYLIB}:${GOOGLELIB} cos.dataset.experiment.QueryClient4Schema1 $*
